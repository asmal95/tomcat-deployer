...
public class TomcatManager {
     ...
     * @throws IOException if an i/o error occurs
     */
    public TomcatManagerResponse deploy(String path, URL war, boolean update) throws IOException {
     ...
     * @throws IOException if an i/o error occurs
     */
    public TomcatManagerResponse deploy(String path, URL war, boolean update, String tag) throws IOException {
     ...
     * @throws IOException if an i/o error occurs
     */
    public TomcatManagerResponse deploy(String path, File war, boolean update) throws IOException {
        return deploy(path, war, update, null);
    }
     ...
     * @throws IOException if an i/o error occurs
     */
    public TomcatManagerResponse deploy(String path, File war, boolean update, String tag) throws IOException {
     ...
     * @throws IOException if an i/o error occurs
     */
    public TomcatManagerResponse deployContext(String path, URL config, boolean update) throws IOException {
     ...
     * @throws IOException if an i/o error occurs
     */
    public TomcatManagerResponse deployContext(String path, URL config, URL war) throws IOException {
     ...
     * @throws IOException if an i/o error occurs
     */
    public TomcatManagerResponse deployContext(String path, URL config, URL war, boolean update) throws IOException {
     ...
     * @throws IOException if an i/o error occurs
     */
    public TomcatManagerResponse getRoles() throws IOException {
        return invoke("/roles");
    }
